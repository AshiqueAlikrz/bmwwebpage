          ...
          <div className="flex justify-center items-center w-4/12 h-full bg-black ">
            ...
            >
              ...
              <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="101.957" x2="193.75" y1="66.595" y2="225.586">
                <stop offset=".033" stop-color="#8c8c8c" />
                <stop offset=".092" stop-color="#646464" />
                <stop offset=".165" stop-color="#393939" />
                <stop offset=".23" stop-color="#1a1a1a" />
                <stop offset=".286" stop-color="#070707" />
                <stop offset=".324" />
              </linearGradient>
              <linearGradient id="c" gradientUnits="userSpaceOnUse" x1="149.788" x2="208.776" y1="148.068" y2="207.057">
                <stop offset=".379" stop-color="#4eb4e2" />
                <stop offset=".984" stop-color="#5e8ba9" />
              </linearGradient>
              <linearGradient id="d" gradientUnits="userSpaceOnUse" x1="134.622" x2="233.227" y1="86.989" y2="143.919">
                ...
                <stop offset=".879" stop-color="#b3b3b3" />
              </linearGradient>
              <linearGradient id="e" gradientTransform="rotate(180 483.581 82.786)" gradientUnits="userSpaceOnUse" x1="886.663" x2="814.954" y1="76.751" y2="35.35">
                <stop offset=".308" stop-color="#5eb4e1" />
                <stop offset=".615" stop-color="#34a7db" />
              </linearGradient>
              ...
              <g fill="none" stroke="#e2001a" stroke-width=".5">
              ...
              <path d="M144.882 232.059c-45.298 0-83.828-38.605-83.41-84.1h83.293z" fill="#fff" stroke="#999" stroke-width="1.966" />
              <path d="M149.78 232.059c45.297 0 83.897-38.475 83.897-84.1h-83.78z" fill="url(#c)" stroke="#424f51" stroke-width="1.966" />
              <path d="M234.73 148.969h-83.78l-.115 79.447-.019 4.65h-1.962l.122-86.055h85.752z" fill="#647180" />
              <path d="M149.78 60.736c45.297 0 81.26 38.263 83.879 82.438l-83.763-.059z" fill="url(#d)" stroke="#a6a6a6" stroke-width="1.954" />
              <path d="M144.882 60.736c-45.298 0-83.37 37.318-83.37 82.379h83.253z" fill="url(#e)" stroke="#a1bbd1" stroke-width="1.954" />
              <path
              ...
              <circle cx="147.018" cy="146.525" fill="none" r="139.462" stroke="#262626" stroke-width="1.1" />
              <path
