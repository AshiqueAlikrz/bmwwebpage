...
useEffect(() => {
  ...
  const showAndHideTwo = useTransform(scrollYProgress, [0, 1], ["-100%", "250%"]);
  const showAndHideOne = useTransform(scrollYProgress, [0, 1], ["40%", "-100%"]);

  return (
    <div ref={containerRef} className="flex items-center justify-evenly flex-col overflow-x-hidden  h-screen w-full ">
      <motion.div style={{ translateX: showAndHideOne }} className="flex  justify-center items-center w-full h-3/6 bg">
      ...
      <motion.div style={{ translateX: showAndHideTwo }} className="flex  justify-center items-center w-full h-3/6 ">
        <div className="w-4/12 h-5/6">
